...
import { PenLine, Mail, Lock, Eye, EyeOff, ArrowRight, AlertCircle } from 'lucide-react';
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6 py-20 relative">
      ...
      <div className="absolute top-10 right-10 w-72 h-72 bg-terracotta-100 rounded-full blur-3xl opacity-20" />
      <div className="absolute bottom-10 left-10 w-64 h-64 bg-sage-100 rounded-full blur-3xl opacity-20" />
      ...
      <div className="w-full max-w-md relative">
        <div className="text-center mb-10">
          ...
          <p className="text-ink-400">Sign in to continue your writing journey</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-ink-400">
          ...
          <Link to="/register" className="text-terracotta-600 font-medium hover:text-terracotta-700 hover:underline">
            Create one
          </Link>
        </p>
      </div>
